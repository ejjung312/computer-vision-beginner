...
currentPath = os.getcwd() + "\\6\\src\\"

# Load names of classes
classesFile = currentPath + "classes.names"
...
modelConfiguration = currentPath + "darknet-yolov3.cfg"
modelWeights = currentPath + "model.weights"
